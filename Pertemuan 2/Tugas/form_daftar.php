...
<body>
    ...
    <form method="POST" action="hasil_daftar.php" class="form-horizontal w-75 mt-5 mx-auto p-4 border shadow-sm">
		<h1> <center> Form Pendaftaran</h1>
		<form>
			<div class="form-group">
				<label for="nama_lengkap">Nama Lengkap</label>
				<input name = "nama lengkap" type="text" class="form-control" id="nama_lengkap">
			</div>
			<div class="form-group">
			...
			<button name = "peroses" value = "submit" class="btn btn-primary">Submit</button>
		</form>
	</div>
</body>
</html>